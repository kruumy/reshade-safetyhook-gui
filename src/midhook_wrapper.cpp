...
#if SAFETYHOOK_ARCH_X86_32
    ctx.eax = live_context[general_purpose_register::EAX].do_override ? live_context[general_purpose_register::EAX].override_value : ctx.eax;
    ctx.ecx = live_context[general_purpose_register::ECX].do_override ? live_context[general_purpose_register::ECX].override_value : ctx.ecx;
    ctx.edx = live_context[general_purpose_register::EDX].do_override ? live_context[general_purpose_register::EDX].override_value : ctx.edx;
    ctx.ebx = live_context[general_purpose_register::EBX].do_override ? live_context[general_purpose_register::EBX].override_value : ctx.ebx;
    ctx.esi = live_context[general_purpose_register::ESI].do_override ? live_context[general_purpose_register::ESI].override_value : ctx.esi;
    ctx.edi = live_context[general_purpose_register::EDI].do_override ? live_context[general_purpose_register::EDI].override_value : ctx.edi;
    ctx.ebp = live_context[general_purpose_register::EBP].do_override ? live_context[general_purpose_register::EBP].override_value : ctx.ebp;
    ctx.trampoline_esp = live_context[general_purpose_register::ESP].do_override ? live_context[general_purpose_register::ESP].override_value : ctx.trampoline_esp;
